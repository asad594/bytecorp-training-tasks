    ...
    >
      <div className="flex items-start justify-between gap-4 mb-4">
        <div className="flex items-center gap-3.5">
          <div
            className={`flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${job.logoBg} font-sora font-bold text-white text-lg shadow-md`}
          >
            {job.logoLetter}
          </div>
          <div>
      ...
      <div className="flex items-center justify-between border-t border-white/10 pt-4">
        <div>
          <span className="font-sora font-bold text-[#67e8f9] text-sm">{job.salary}</span>
          <span className="block text-[0.68rem] text-slate-400">{job.posted}</span>
        </div>
